export default function InputForm({ updateCustomerFunc, customerInfo }) {
  const previous_customer_name = customerInfo[0].customer_name;
  const previous_customer_id = customerInfo[0].customer_id;
  const previous_age = customerInfo[0].age;
  const previous_gender = customerInfo[0].gender;
